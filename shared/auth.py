...
def _init_schema():
    ...
    for stmt in [
        ...
        """CREATE TABLE IF NOT EXISTS email_events (
            ...
            sg_event_id VARCHAR(100) UNIQUE,
        ...
        """CREATE INDEX IF NOT EXISTS idx_email_events_hh_camp_sent ON email_events(household_id, campaign, event_type)""",
        """CREATE INDEX IF NOT EXISTS idx_email_events_email_camp ON email_events(email, campaign)""",
...
def claim_trial_extension(household_id=None, user_id=None, tier=None):
    ...
    hh = _one(f"""
        SELECT id, name, is_premium, subscription_status, trial_ends_at, created_at,
    ...
    if is_legacy_30d:
        ...
        extra_set = ", trial_ext_15d_claimed_at = COALESCE(trial_ext_15d_claimed_at, NOW())"
    else:
        extra_set = ""
        if norm_tier == "7d":
            if c_7d:
