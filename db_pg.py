...
_SCHEMA = [
    ...
    "CREATE TABLE IF NOT EXISTS app_feedback (id SERIAL PRIMARY KEY, household_id INTEGER, user_email TEXT, user_name TEXT, feedback_type TEXT, rating INTEGER DEFAULT 0, message TEXT, created_at TIMESTAMP NOT NULL DEFAULT NOW())",
]
...
def init_db():
    ...
    try:
        ...
        try: db.execute("ALTER TABLE app_feedback ADD COLUMN IF NOT EXISTS rating INTEGER DEFAULT 0")
        except Exception: pass
